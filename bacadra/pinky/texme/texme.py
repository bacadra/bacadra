...
class TeXM:
    ...
    def tex(self,
        ...
        '''
        *** texme ***: Insert LaTeX code into tex report.
    ...
    def head(self,
        ...
        '''
        *** texme ***: add header to the project
...
#$ ____ class texme_________________________________________________________ #
...
class texme(TeXM, object, metaclass=texmemeta):
    ...
    #$$ def push
    def push(self, calcN=None, fclear=None, force_mode=False, shell_escape=False, synctex=True, active=None):
        if active is None:
            active = self.active
