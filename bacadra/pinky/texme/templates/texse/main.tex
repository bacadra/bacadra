...
\newcommand{\MONTH}{%
  ...
  \fi}
% \usepackage{datetime}
% \renewcommand{\MONTH}{\monthnameenglish[\month]}
\newcommand{\YEAR}{\number\year}
...
% rodzaj naglowka, plain -> tylko numerowanie stron
\pagestyle{plain}
...
\fancypagestyle{plain}{
  ...
  \fancyfoot[C]{\footnotesize{\textcolor{Gray}{\MONTH~\YEAR~r.}}} %<foot_line_left>%
}
...
% usuwa head and foot na stronie z chapterem
...
%O ptions: Sonny, Lenny, Glenn, Conny, Rejne, Bjarne, Bjornstrup
...
\lstdefinestyle{bcdr_rst_tables}{
    style             = bcdr0,
    frame             = none,
}

\lstdefinestyle{bcdr1}{
    style             = bcdr0,
    language          = Python,
}
...
\newcommand  {\ol}[1]{\overline{#1}}  % line over symbol
\newcommand  {\g}[1]{\textgreek{#1}} % textgreek
...
%
\begin{center}
\includegraphics[frame,width=0.999\linewidth,height=0.95\textheight,keepaspectratio]{../../../../../../d# pictures/a# temp/happy-bears-wallpaper.jpg}
\end{center}
%
$a+b+c \cdot 2+2$
%
